<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BandPack.aspx.cs" Inherits="PSDLEC.View.BandPack" %>
    ...
    <br>
      ...
      <div class="card" style="width: 90%; margin: auto; background-color: rgba(63, 56, 96, 0.486);" >
        ...
        <div class="card-body">
          ...
          <br>
          <br>
          <p class="card-text" style="color: rgb(231, 230, 230); font-size: 20px; font-family: orbitron;">Price:&nbsp; Rp.1,500,000</p>
          <br>
          <br>
          <center><asp:Button ID="CheckOutBandButton" class="btn btn-outline-light" runat="server" Text="Check Out" OnClick="CheckOutBandButton_Click" /></center>
